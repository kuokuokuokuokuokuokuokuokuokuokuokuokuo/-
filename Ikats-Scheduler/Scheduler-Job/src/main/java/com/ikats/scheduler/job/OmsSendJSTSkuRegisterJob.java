...
public class OmsSendJSTSkuRegisterJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException
    {
        ...
        try {
            ...
            String clients = OmsJSTPostUtil.PostXml(omsXml);
            ...
            Email.sendTextMail("liukuo@ikats.com", "聚水潭商品备案发送任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("zhangxiaotao@ikats.com", "聚水潭商品备案发送任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("wuqing@ikats.com", "聚水潭商品备案发送任务", ExceptionUtils.getStackTrace(e));
        }finally
        {
