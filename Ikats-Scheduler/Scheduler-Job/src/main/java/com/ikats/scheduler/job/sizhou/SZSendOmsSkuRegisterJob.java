...
public class SZSendOmsSkuRegisterJob extends QuartzJobBean
{
...
//                    System.out.println(omsRequest);
                            String result = SZOmsPostUtil.PostXml(omsRequest);
                            if(i == 0)
                            {
                ...
                }catch (DmsOrderSettlementException e)
                {
                    ...
                    Email.sendTextMail("liukuo@ikats.com", "四洲商品备案发送任务", ExceptionUtils.getStackTrace(e));
                    Email.sendTextMail("zhangxiaotao@ikats.com", "四洲商品备案发送任务", ExceptionUtils.getStackTrace(e));
                    Email.sendTextMail("wuqing@ikats.com", "四洲商品备案发送任务", ExceptionUtils.getStackTrace(e));
                }finally
                {
