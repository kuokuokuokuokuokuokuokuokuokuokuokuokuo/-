...
public class JuShuiTanGetPurchaseOrdersJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException
    {
        ...
        try {
            ...
            Email.sendTextMail("liukuo@ikats.com", "聚水潭采购单抓取任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("zhangxiaotao@ikats.com", "聚水潭采购单抓取任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("wuqing@ikats.com", "聚水潭采购单抓取任务", ExceptionUtils.getStackTrace(e));
        }
