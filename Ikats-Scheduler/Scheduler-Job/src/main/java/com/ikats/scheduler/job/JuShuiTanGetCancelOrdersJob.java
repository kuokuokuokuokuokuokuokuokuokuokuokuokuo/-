...
public class JuShuiTanGetCancelOrdersJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        } catch (Exception e)
        {
            ...
            Email.sendTextMail("liukuo@ikats.com", "聚水潭取消订单抓取任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("zhangxiaotao@ikats.com", "聚水潭取消订单抓取任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("wuqing@ikats.com", "聚水潭取消订单抓取任务", ExceptionUtils.getStackTrace(e));
        }
