...
public class JSTAllocateJob  extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        try{
            ...
            Email.sendTextMail("liukuo@ikats.com", "聚水潭调拨单抓取任务", ExceptionUtils.getStackTrace(ex));
            Email.sendTextMail("zhangxiaotao@ikats.com", "聚水潭调拨单抓取任务", ExceptionUtils.getStackTrace(ex));
            Email.sendTextMail("wuqing@ikats.com", "聚水潭调拨单抓取任务", ExceptionUtils.getStackTrace(ex));
        }
