...
public class SZSendOmsCancelOrderJob extends QuartzJobBean
{
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException
    {
        ...
        }catch (DmsOrderSettlementException e)
        {
            ...
            Email.sendTextMail("liukuo@ikats.com", "四洲取消订单发送任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("zhangxiaotao@ikats.com", "四洲取消订单发送任务", ExceptionUtils.getStackTrace(e));
            Email.sendTextMail("wuqing@ikats.com", "四洲取消订单发送任务", ExceptionUtils.getStackTrace(e));
        }finally
        {
