...
public interface IGYOrderRepository {
    ...
    /** 分页查询 */
    List<GYOrderBean> pageByQuery(int offset, int pageSize, Map<String, String> express);

    List<GYOrderBean> pageByQueryException(int offset, int pageSize, Map<String, String> express);

    /** 根据订单号修改 **/
    void updateByOrderNo(GYOrderBean bean);

    List<GYOrderBean> selectByNo(Map<String, String> express);
