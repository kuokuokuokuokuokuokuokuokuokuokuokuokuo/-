 ...
 */
public class GuanYiPostUtil
{
    //测试环境 管易配置
//    public static final String URL = "http://v2.api.guanyierp.com/rest/erp_open";
...
//    正式的
    public static final String APPKEY = "191819";
    public static final String SECRET = "8dbb6c4c699b4562a7cf022c715044f5";
    public static final String SESSIONKEY = "91e8c1be28ca4fdaadea4179055ac3a3";
